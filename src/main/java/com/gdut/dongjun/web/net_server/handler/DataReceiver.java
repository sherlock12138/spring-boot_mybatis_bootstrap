...
public class DataReceiver extends ChannelInboundHandlerAdapter {
	...
	public void saveCV(String switchId, String data) {
		...
		case "0201ff00":
			...
			dStrings = CommandUtil.divideResult(data, 4);
		...
		case "0202ff00":
			...
			dStrings = CommandUtil.divideResult(data, 6);
	...
	private void readHitchEvent(String id, String address, String data) {
		...
		if (address != null && id != null) {
			...
			HitchEvent hitchEvent = CommandUtil.readHitchEvent(data);// 查询开关的结果
			hitchEvent.setId(UUIDUtil.getUUID());
			hitchEvent.setSwitchId(id);
			HitchEvent hitchEvent2 = hitchEventService.getRecentlyHitchEvent();
