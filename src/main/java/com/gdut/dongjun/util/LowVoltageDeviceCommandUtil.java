...
public class LowVoltageDeviceCommandUtil{
	...
	public LowVoltageDeviceCommandUtil() {
	}

	public LowVoltageDeviceCommandUtil(String address) {
		setAddress(address);
	}
	...
	public static String controlSwitch(String address, DataZone dataZone) {
		// TODO Auto-generated method stub
		LowVoltageDeviceCommandUtil commandUtil = new LowVoltageDeviceCommandUtil();
		commandUtil.setAddress(address);
		commandUtil.setControl(CommandControlCode.CONTROL_DEVICE.toString());
		commandUtil.setData(dataZone.creatDataZoneArrays(1));
