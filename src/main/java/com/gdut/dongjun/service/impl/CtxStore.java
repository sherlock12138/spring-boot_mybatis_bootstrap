	...
	public static void hitchEventSpy() {
		...
		for (SwitchGPRS switchGPRS : ctxlist) {
			...
			if (switchGPRS != null && switchGPRS.getCtx() != null
				...
				String msg = CommandUtil.read(switchGPRS.getAddress(),
	...
	public static void timedCVReadTask() {
		...
		for (SwitchGPRS switchGPRS : ctxlist) {
			...
			if (switchGPRS != null && switchGPRS.getCtx() != null
				...
				// 读取电压
				String msg = CommandUtil.readAllPhaseVoltage(switchGPRS
						.getAddress());
				...
				// 读取电流
				msg = CommandUtil.readAllPhaseCurrent(switchGPRS.getAddress());
